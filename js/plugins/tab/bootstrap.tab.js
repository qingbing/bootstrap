...
(function ($) {
    $.fn.extend({
         ...
         * @returns {template}
         */
        bootTab: function (options) {
            $(this).each(function () {
                var $tab = $(this);
                var $tabHead = $tab.children('.w-tab-head').addClass('nav nav-tabs').attr('role', 'tablist');
                ...
                var $tabBody = $tab.children('.w-tab-body').addClass('tab-content list-unstyled');
